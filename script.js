...
btnEnvoyer.addEventListener("click", () => {
  ...
  .then(res => res.text())
  .then(() => {
    status.textContent = "Commande envoyée avec succès ! Un mail vous a été envoyé avec le récapitulatif de votre commande. Vous allez bientôt recevoir un mail pour rentrer vos coordonnées";
